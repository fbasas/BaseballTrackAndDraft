...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('draft_team', 'name')

        # Adding field 'Team.teamName'
        db.add_column('draft_team', 'teamName', self.gf('django.db.models.fields.CharField')(default='', max_length=50), keep_default=False)

        # Adding field 'Team.managerName'
        db.add_column('draft_team', 'managerName', self.gf('django.db.models.fields.CharField')(default='', max_length=50), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Team.name'
        db.add_column('draft_team', 'name', self.gf('django.db.models.fields.CharField')(default='', max_length=50), keep_default=False)

        # Deleting field 'Team.teamName'
        db.delete_column('draft_team', 'teamName')

        # Deleting field 'Team.managerName'
        db.delete_column('draft_team', 'managerName')
    ...
    models = {
        ...
        'draft.team': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'league': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['draft.League']"}),
            'managerName': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'teamName': ('django.db.models.fields.CharField', [], {'max_length': '50'})
        }
    }
