...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'BatterYearLine.league'
        db.add_column('draft_batteryearline', 'league', self.gf('django.db.models.fields.CharField')(default='', max_length=3), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'BatterYearLine.league'
        db.delete_column('draft_batteryearline', 'league')
