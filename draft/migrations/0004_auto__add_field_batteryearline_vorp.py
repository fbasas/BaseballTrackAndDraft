...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'BatterYearLine.vorp'
        db.add_column('draft_batteryearline', 'vorp', self.gf('django.db.models.fields.DecimalField')(default=0.0, max_digits=5, decimal_places=1), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'BatterYearLine.vorp'
        db.delete_column('draft_batteryearline', 'vorp')
